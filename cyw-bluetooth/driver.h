...
//
#define SUPPORTED_RESET_RECOVERY_TYPE ResetRecoveryTypeNone
...
{
    ULONG BtStage, BtStatus, BtFirmwareCommands, BtBaud, BtChipId, BtBuild, BtBootLineErrors;
    UCHAR BtAddress[6];
...
VOID ReadSegmentStateSet(PUART_READ_CONTEXT Context, UART_READ_STATE State);
...
VOID BtCheckpoint(PFDO_EXTENSION Context, ULONG Stage, NTSTATUS Status);
